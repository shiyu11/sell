...
<div>
  <div class="shopcart">
    ...
    <!--<div v-if="ball in balls" v-show="ball.show" class="ball"></div>-->
    <!--</transition>-->
    <!--&lt;!&ndash;两个方向的未知的改变需要内层&ndash;&gt;-->
  ...
  .shopcart
    ...
    .content
      ...
      .content-left
        flex: 1 //自适应
        .logo-wrapper
          display: inline-block //横向排列选择inline-block出现间隙问题将父级的font-size设置为0
          vertical-align: top
          position: relative
          top: -10px
          margin: 0 12px
